...
type ProjectObject =
  ...
  | { name: 'lead', args?: ProjectLeadArgs[] | false, alias?: string  } 
...
export interface ProjectFieldDetails {
  ...
  lead: {
    type: 'Person'
    args: Record<ProjectLeadArgs, core.NexusArgDef<string>>
    description: string
    list: true
    nullable: false
    resolve: (
...
export interface ProjectWhereInput {
  ...
  lead_every?: PersonWhereInput | null
  lead_some?: PersonWhereInput | null
  lead_none?: PersonWhereInput | null
...
export type ProjectWhereInputInputObject =
  ...
  | { name: 'lead_every', alias?: string  } 
  | { name: 'lead_some', alias?: string  } 
  | { name: 'lead_none', alias?: string  } 
...
export interface ProjectCreateWithoutPeopleInput {
  ...
  name?: string
  description?: string
  lead?: PersonCreateManyInput | null
...
export interface ProjectUpdateWithoutPeopleDataInput {
  name?: string | null
  description?: string | null
  lead?: PersonUpdateManyInput | null
